...
function Privacy_Policy() {
    return(
    <>
    <div className="policy-div" style={{ fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif', padding: '1em' }}>
      <strong>Privacy Policy</strong>
      <p>This privacy policy applies to the Sales Tax Calculator app (hereby referred to as "Application") for mobile devices that was created by RiceRoll (hereby referred to as "Service Provider") as an Ad Supported service. This service is intended for use "AS IS".</p>
      <br />
      ...
      <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at brianp.le@outlook.com and they will respond in a reasonable time.</p>
      <br />
      ...
      <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at brianp.le@outlook.com.</p>
      <hr />
    </div>
    </>
    );
